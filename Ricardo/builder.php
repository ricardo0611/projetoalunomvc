...
class HTMLPage {  //Atributos de uma página
    private $page = NULL;
    ...
    function setTitle($title_in) {  //Titulo da ágina
      $this->page_title = $title_in;
    }
    function setHeading($heading_in) {   //Cabeçalho da página
      $this->page_heading = $heading_in;
    }
    function setText($text_in) {  //Textos que terá na página
